          ...
          return (
            <motion.button key={p.id}
              ...
              style={{
                ...
                background: isSelected ? "rgba(201,165,90,0.10)" : isPlaced ? "rgba(22,163,74,0.04)" : t.cardBg,
      ...
      <div style={{ display: "flex", flexDirection: "column", flex: 1, gap: 8, minWidth: 0, minHeight: 0 }}>
        ...
        <div className="hidden md:flex" style={{ flexShrink: 0, alignItems: "center", gap: 8 }}>
          {[
            ...
            const Icon = c.icon;
            return (
              <motion.div key={i} whileHover={{ y: -1 }} style={{ display: "flex", alignItems: "center", gap: 6, padding: "7px 14px", borderRadius: 12, background: t.cardBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(186,230,253,0.55)", boxShadow: "0 1px 4px rgba(14,165,233,0.05)" }}>
                ...
                <div key={group.label}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
                    {group.shelves.map(shelf => {
                      ...
                      return (
                        <div key={shelf.id} style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 12px", borderRadius: 10, background: t.cardBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: `1px solid ${group.color}22` }}>
                          ...
                          <button onClick={() => startEdit(shelf)}
                            style={{ width: 26, height: 26, borderRadius: 7, border: "1px solid #e2e8f0", background: t.cardBg, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
                            <Edit3 size={11} style={{ color: "#64748b" }} />
                          </button>
                          {/* Remove shelf */}
                          <button onClick={() => { if (confirm(`Xoá kệ "${shelf.name}"?`)) onRemove(shelf.id); }}
                            style={{ width: 26, height: 26, borderRadius: 7, border: "1px solid #fee2e2", background: t.cardBg, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center" }}>
    ...
    <div style={{ display: "flex", gap: 14, flex: 1, minHeight: 0 }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", flex: 1, gap: 8, minWidth: 0, minHeight: 0 }}>
        ...
        <div style={{ flexShrink: 0, display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          <div style={{ flex: 1, minWidth: 160, display: "flex", alignItems: "center", gap: 8, background: t.cardBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(186,230,253,0.55)", borderRadius: 12, padding: "0 12px", height: 38 }}>
          ...
          <div className="hidden md:flex" style={{ gap: 6 }}>
            {[
              ...
              <div key={s.label} style={{ display: "flex", alignItems: "center", gap: 4, padding: "0 12px", height: 38, borderRadius: 12, background: t.cardBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(186,230,253,0.55)" }}>
...
function ShelfView({ shelf, products, selectedPid, highlightPid, canEdit, onPlace, onScanToPlace, onRemove }: {
  ...
  return (
    <div style={{ background: t.cardBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", borderRadius: 16, border: "1px solid rgba(186,230,253,0.55)", overflow: "hidden", boxShadow: "0 2px 12px rgba(14,165,233,0.06)" }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
      ...
      <AnimatePresence initial={false}>
        <motion.div key={sub.id} initial={{ opacity: 0, x: 12 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -12 }} transition={{ duration: 0.15 }}
          style={{ background: t.cardBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: `1px solid ${cfg.color}30`, borderRadius: 14, overflow: "visible", boxShadow: `0 2px 10px ${cfg.color}08` }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 8, height: "100%", minHeight: 0 }}>
      ...
      <div style={{ flexShrink: 0, display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
        ...
        <motion.button onClick={handleRefresh} title="Tải lại"
          whileHover={{ scale: 1.08 }} whileTap={{ scale: 0.93 }}
          style={{ width: 36, height: 36, borderRadius: 11, border: "1px solid rgba(186,230,253,0.55)", background: t.cardBg, backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", boxShadow: "0 1px 4px rgba(14,165,233,0.08)" }}>
